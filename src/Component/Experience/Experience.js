...
const experience1 = [
  "Developed 20+ high-performance web and mobile games using JavaScript and Cocos2d, with rich interactive UIs for football, basketball, cricket, and trivia formats.",
  "Implemented responsive and animated game UIs, integrating Socket.IO for real-time multiplayer interactions and live audience engagement with 5,000+ concurrent users.",
  "Improved asset loading, responsiveness, and cross-platform performance across web, Android, and iOS, achieving 60FPS gameplay and reducing crash rates by 40%.",
  "Collaborated cross-functionally with designers, QA, and backend developers to ensure seamless integration of game logic and real-time APIs.",
  "Participated in testing, debugging, and deployment cycles; contributed to release pipelines and CI coordination using Git and project-level tooling.",
];
const experience2 = [
  "Created and reviewed over 30+ high-quality coding challenges in C++, SQL, and Java, ranging from beginner to advanced levels.",
  "Collaborated with the review team to ensure logical accuracy, optimal solutions, and real-world relevance of each problem.",
  "Streamlined test case generation and validation processes, reducing review cycle time by 40%.",
  "Incorporated feedback-driven improvements that enhanced question clarity and reduced candidate error rates by 25%.",
  "Ensured alignment of challenges with industry-standard assessments, contributing to a 35% increase in overall evaluation reliability.",
];
const experience3 = [
  "Authored over 60 algorithmic challenges in C++ focused on core topics such as DSA, recursion, and dynamic programming.",
  "Designed questions to rigorously assess candidates' problem-solving depth, logical reasoning, and code optimization skills.",
  "Maintained a high challenge acceptance rate of 92% based on quality benchmarks and internal review criteria.",
  "Collaborated with the content evaluation team to ensure edge case coverage and efficient solution paths.",
  "Ensured topic diversity and difficulty balance across challenges, aligning with various technical screening levels.",
];
...
const Experience = () => {
  ...
  window.addEventListener("scroll", () => {
    const rotation = window.scrollY * 0.25; // speed multiplier
            ...
            <div className="experience-body">
              <div className="company">
                ...
                <p data-aos="zoom-in-right">
                  Software Developer @ Aquimo Pvt. Ltd.
                </p>
              </div>
              <div className="experience-data">
                <div className="left-part">
                  ...
                  <p data-aos="fade-left">
                    {" "}
                    <MdLocationPin /> Onsite, Gurugram
                  </p>
                  <p data-aos="fade-left">
                    <FaLaptopCode /> Full - Time
                  </p>
                </div>
                ...
                <ol>
                  {experience1.map((exp, index) => (
                    <li className="custom-li" data-aos="fade-right" key={index}>
          ...
          <div className="experience-data">
            <div className="experience-body">
              <div className="company">
                {" "}
                <p data-aos="zoom-in-right">
                  Problem Setter & Reviewer @ Techcurators
                </p>
              </div>
              <div className="experience-data">
                <div className="left-part">
